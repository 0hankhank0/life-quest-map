...
export function MapPanel() { return <div className="space-y-5"><PageHeader eyebrow="World Map" title="探索地圖" description="示範據點只供體驗功能使用；你也可以新增自訂探索點與任務。" /><DynamicMapView /></div>; }
