...
const sections: Array<{ id: QuestGuildSection; label: string; empty: string }> = [
  { id: "today", label: "今日", empty: "今天沒有到期或每日任務。" }, { id: "inProgress", label: "進行中", empty: "沒有進行中的支線任務。" }, { id: "upcoming", label: "即將到期", empty: "未來七天沒有任務到期。" }, { id: "main", label: "主線任務", empty: "建立一個主線任務，拆解大型目標。" }, { id: "completed", label: "已完成", empty: "完成的任務會保留在這裡。" }, { id: "all", label: "全部任務", empty: "新增第一個任務。" }
];
